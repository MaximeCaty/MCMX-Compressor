...
| **Shared dictionary** | Unlike BWT-based compressors, MCM's Mixed Context model tolerates threading with minimal ratio loss — the shared dictionary is preserved across threads to keep compression quality high |
